...
- _main.R_: please run this file
- _functions.R_: constains the main function to fit SDGLMC
- _example_dataset.RData_: contains simulated spatio-temporal data
- _Wcont.csv_, _centroids.csv_, _offset.csv_: additional files needed for the analysis
